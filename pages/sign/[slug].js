...
const Page = ({ title, range, smallLogo, content, image, compatabilitySign1, compatabilitySign2, compatabilitySign3, comp1percent, comp2percent, comp3percent, videobackground, rangeFrom, rangeTo }) => {
...
export async function getStaticProps({ params }) {
    ...
    const {
        properties: { title, range, content, image, smallLogo, compatabilitySign1, compatabilitySign2, compatabilitySign3, comp1percent, comp2percent, comp3percent, videobackground, rangeFrom, rangeTo }
    } = category;
    return {
        props: {
            title,
